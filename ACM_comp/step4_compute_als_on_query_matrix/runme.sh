...
../helpers/convert_to_matrix_market_format.sh /mnt/small_query_matrix
...
pmf /mnt/small_query_matrix.matrix.market 0 --scheduler="round_robin(max_iterations=10,block_size=1)" --matrixmarket=true --lambda=0.065 --ncpus $cpus
popd